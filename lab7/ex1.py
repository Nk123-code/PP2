...
bg = pygame.image.load(r'C:\Users\Admin\Documents\KBTU\GitHub\pp2\lab7\Bas2.png').convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load(r"C:\Users\Admin\Documents\KBTU\GitHub\pp2\lab7\second.png")
left_rect = image_left.get_rect(bottomleft = (415,560))
image_right = pygame.image.load(r"C:\Users\Admin\Documents\KBTU\GitHub\pp2\lab7\minute.png")
